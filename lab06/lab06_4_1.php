...
<body>
        ...
        <form method="post" enctype="multipart/form-data">
            <table align="center">
                ...
                <tr>
                    <td>Thông tin: </td>
                    <td>
                        <textarea name="thong_tin" cols="40" rows="2"></textarea>
                    </td>
                </tr>
                <tr>
    ...
    if ($sm != "") {
        ...
        if (strlen($password1) < 6)         $err .= "Mật khẩu phải ít nhất 6 ký tự.<br>";
    ...
    <div class="info">
        <?php
            ...
            if ($err != "") echo $err;
                ...
                echo "Mật khẩu đã mã hóa Sha1 tu md5:" . sha1(md5($password1)) . "<br>";
